  ...
  Hub.listen("auth", async ({ payload }) => {
    switch (payload.event) {
      ...
      case "customOAuthState":
        ...
        console.log("Custom OAuth state: ", state);
        break;
      // Add additional cases for other auth events as needed
    }
  });
};
</script>
...
<!-- <template>
  <button @click="handleSignInClick">Sign in with Google</button>
  <button @click="handleSignOut">Sign in out Google</button>
  <h1>Test</h1>
</template> -->
